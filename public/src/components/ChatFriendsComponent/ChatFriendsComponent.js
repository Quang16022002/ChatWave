...
const ChatFriendsComponent = ({ friend, messages, inputValue, handleInputChange, handleSendMessage }) => {
  ...
  return (
    <div className="ChatFriendsComponent">
      ...
      {tagsPopupVisible && (
        <div className="ChatFriendsComponent-tags-popup" style={{ marginTop:'-750px',width:'100%' }}>
          <div className="ChatFriendsComponent-tags-popup-content">
            <div className='item-tag-chat'> 
              <img src={book} style={{width:'30px',height:'30px'}}></img>
              <h6 style={{paddingTop:'5px',paddingRight:'5px'}}> Sách</h6>
              <h6 style={{color:"#ff004d",paddingTop:'4px'}}>6</h6>
            </div>
            <div className='item-tag-chat'> 
              <img src={coin} style={{width:'30px',height:'30px'}}></img>
              <h6 style={{paddingTop:'5px',paddingRight:'5px'}}> Tiền xu</h6>
              <h6 style={{color:"#ff004d",paddingTop:'4px'}}>9</h6>
            </div><div className='item-tag-chat'> 
              <img src={pet} style={{width:'30px',height:'30px'}}></img>
              <h6 style={{paddingTop:'5px',paddingRight:'5px'}}> Thú cưng</h6>
              <h6 style={{color:"#ff004d",paddingTop:'4px'}}>3</h6>
            </div>
            <div className='item-tag-chat'> 
              <img src={light} style={{width:'30px',height:'30px'}}></img>
              <h6 style={{paddingTop:'5px',paddingRight:'5px'}}> Ý tưởng</h6>
              <h6 style={{color:"#ff004d",paddingTop:'4px'}}>5</h6>
            </div>
            <div className='item-tag-chat'> 
              <img src={time} style={{width:'30px',height:'30px'}}></img>
              <h6 style={{paddingTop:'5px',paddingRight:'5px'}}> Thời gian</h6>
              <h6 style={{color:"#ff004d",paddingTop:'4px'}}>1</h6>
            </div>
        ...
        <div className="ChatFriendsComponent-ellipsis-popup" style={{ position: 'absolute', width: '100%', height: '100%', top: 0, left: 0, backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
          <div className="ChatFriendsComponent-ellipsis-popup-content" style={{ width: '100%', height: '100%', backgroundColor: '#fff' }}>
            ...
            <div className='informatuon-ellipsis-popup'>
              ...
              <h4 style={{color:'orange'}}>@Mycute45</h4>
              </div>
            ...
            <h4 style={{color:'#ff004d'}}>40</h4>
            <h4>Ảnh</h4>
            <i class="fa fa-arrow-circle-right" aria-hidden="true" style={{color:'#ff004d',fontSize:'30px',paddingLeft:'350px'}}></i>
              </div>
            ...
            <h4>Video</h4>
            <i class="fa fa-arrow-circle-right" aria-hidden="true" style={{color:'#ff004d',fontSize:'30px',paddingLeft:'330px'}}></i>
            ...
            <h4>Files</h4>
            <i class="fa fa-arrow-circle-right" aria-hidden="true" style={{color:'#ff004d',fontSize:'30px',paddingLeft:'345px'}}></i>
            ...
            <i class="fa fa-arrow-circle-right" aria-hidden="true" style={{color:'#ff004d',fontSize:'30px',paddingLeft:'350px'}}></i>
              ...
              <div className='item-content-ellipsis-popup' style={{borderBottom:'0px',background:"rgb(250, 237, 215)"}}>
                <div className='item-link-ellipsis-popup'>
                  ...
                  <div className='item-link-ellipsis-popup-inf' >
                    <h5>Quangzzz222/project-reactjs-chatwave</h5>
                    <h5 style={{color:'#ff004d'}}>github.com</h5>
                  </div>
                </div>
              </div>
              <div className='item-content-ellipsis-popup' style={{background:"rgb(250, 237, 215)"}}>
              ...
              <div className='item-content-ellipsis-popup'>
                <h3 style={{margin:'0px'}}> Bảo mật</h3>
              </div>
              <div className='item-content-ellipsis-popup' style={{borderBottom:'0px'}}>
                <div className='security-ellipsis-popup'>
                  ...
                  <div className='security-ellipsis-popup-inf'>
                    <h5 style={{margin:'0px'}}>Tự động xóa tin nhắn</h5>
                    <h6 style={{color:'orange'}}>5 phút</h6>
                  </div>
                </div>
              ...
              <div className='item-content-ellipsis-popup'>
                <div className='security-ellipsis-popup'>
                  <div className='security-ellipsis-popup-img'>
                  <i class='fa fa-trash' style={{fontSize:'40px'}}></i>

                  </div>
                  <div className='security-ellipsis-popup-inf' >
                    <h5 style={{padding:'5px'}}>Xóa lịch sử trò chuyện</h5>
                  </div>
                </div>
              </div>
              <div className='item-content-ellipsis-popup'>
                <h3 style={{margin:'0px'}}>Dịch thuật</h3>
              </div>
              <div className='item-content-ellipsis-popup' style={{border:'0px'}}>
              <i class='fa fa-cc' style={{fontSize:'40px'}}></i>
              <h5 style={{paddingTop:'10px'}}> Phụ đề</h5>
